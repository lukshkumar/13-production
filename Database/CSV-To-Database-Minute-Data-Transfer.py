...
minute_data_path = "../TDAmeritrade/Minute/TDAmeritrade-Minute-Data-By-Ticker-Split-Applied/"
entries = os.listdir(minute_data_path)
...
with engine.connect() as con:    
    for entry in entries:
        try:
            df = pd.read_csv(minute_data_path + entry)
            ...
            #print(df.head())
            no_of_rows_inserted = df.to_sql('TDAmeritradeMinutePrice', engine, if_exists = "append", index = False)
