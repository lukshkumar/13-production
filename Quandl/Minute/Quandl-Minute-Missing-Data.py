...
# Start and End Time for Few missing Days. Both dates (start_date and end_date are inclusive)
...
for i in range((end_date - start_date).days + 1):
    ...
    date_to_fetch_data = str(current_date).replace("-","")
    print("Date: ", date_to_fetch_data, " Day: ", current_day)
